...
from google3.cloud.ai.platform.notebook.image.build.shared_src.common.packages.gemini_cli.geminicli.tools import (
    geminicli_magic,
)
...
class GeminicliMagicTest(googletest.TestCase):
  ...
  def setUp(self):
    ...
    self.mock_print = self.enter_context(mock.patch("builtins.print"))
